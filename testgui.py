...
from testbot import chat, response
import pyttsx3
import threading
...
# Menu bar
    ...
    # Options
        ...
        font.add_command(label="Arial",command=self.font_change_arial)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("Chatpal","BOT: I will provide answers to your queries about CPE Program. If you wish to exit, type quit!")

    def about(self):
        tkinter.messagebox.showinfo("BOT: I will provide answers to your queries about CPE Program. If you wish to exit, type quit!")
    ...
    def font_change_default(self):
        self.text_box.config(font="Arial 10")
        self.entry_field.config(font="Arial 10")
        self.font = "Arial 10"
